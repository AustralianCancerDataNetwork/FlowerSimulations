...
h_client_1_data = pd.read_csv(f'datasets/{folder}/data_H_1.csv')
...
mask_W1 = pd.read_csv(f'masks/{folder}/mask_client_H_1_W1.csv')
mask_W1 = mask_W1.to_numpy()

mask_W2 = pd.read_csv(f'masks/{folder}/mask_client_H_1_W2.csv')
mask_W2 = mask_W2.to_numpy()

mask_W3 = pd.read_csv(f'masks/{folder}/mask_client_H_1_W3.csv')
mask_W3 = mask_W3.to_numpy()

mask_b2 = pd.read_csv(f'masks/{folder}/mask_client_H_1_b2.csv')
mask_b2 = mask_b2.to_numpy()

mask_b3 = pd.read_csv(f'masks/{folder}/mask_client_H_1_b3.csv')
mask_b3 = mask_b3.to_numpy()
...
class FlowerClient(NumPyClient):
    ...
    def get_parameters(self, config):
        ...
        if self.current_round > 4:
            ...
            if self.current_round % 2 == 1:
                ...
                # Reshape, concatenate and add masks
                W1_h_r = reshape_to_5_rows(self.W1_h) + mask_W1
                W2_r = reshape_to_5_rows(self.W2) + mask_W2
                b2_r = reshape_to_5_rows(self.b2) + mask_b2
                W3_r = reshape_to_5_rows(self.W3) + mask_W3
                b3_r = reshape_to_5_rows(self.b3) + mask_b3
        ...
        if parameters:
            ...
            if self.current_round > 4:
                ...
                if self.current_round % 2 == 1:
                    ...
                    encrypted_Z1 = parameters[1]

                    encrypted_Z1 = encrypted_Z1.tobytes()
                    ...
                    self.Z1_v = np.frombuffer(decrypted_bytes, dtype=np.float32).reshape([5, 10000])
    ...
    def save_metrics(self):
        ...
        df.to_csv(f'results/{folder}/training_metrics_Client_H_1.csv', index=False)
        ...
        plt.ylabel("Loss")
        plt.title("Training Loss over Rounds-Client_H_1")
        plt.legend()
        plt.grid()
        plt.savefig(f'results/{folder}/loss_plot_Client_H_1.jpeg', dpi=300)
        ...
        plt.xlabel("Training Rounds")
        plt.ylabel("Accuracy")
        plt.title("Training Accuracy over Rounds-Client_H_1")
        plt.legend()
        plt.grid()
        plt.savefig(f'results/{folder}/accuracy_plot_Client_H_1.jpeg', dpi=300)

...
mask_W1 = pd.read_csv(f'masks/{folder}/mask_client_H_2_W1.csv')
mask_W1 = mask_W1.to_numpy()

mask_W2 = pd.read_csv(f'masks/{folder}/mask_client_H_2_W2.csv')
mask_W2 = mask_W2.to_numpy()

mask_W3 = pd.read_csv(f'masks/{folder}/mask_client_H_2_W3.csv')
mask_W3 = mask_W3.to_numpy()

mask_b2 = pd.read_csv(f'masks/{folder}/mask_client_H_2_b2.csv')
mask_b2 = mask_b2.to_numpy()

mask_b3 = pd.read_csv(f'masks/{folder}/mask_client_H_2_b3.csv')
        ...
        if parameters:
            ...
            if self.current_round > 4:
                ...
                if self.current_round % 2 == 1:
                    ...
                    self.Z1_v = np.frombuffer(decrypted_bytes, dtype=np.float32).reshape([5, 235057])

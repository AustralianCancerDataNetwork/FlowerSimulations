...
class FlowerClient(NumPyClient):
    ...
    def set_parameters(self, parameters):
        ...
        if parameters:
            ...
            print("Round Number: "+str(self.current_round))
            ...
            print(f"\033[34mReceived Round {self.current_round} - Received Matrix:\n{self.previous_avg}\033[0m")
